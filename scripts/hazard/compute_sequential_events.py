...
def main():
    ...
    if not exp_path.exists():
        ...
        print("Options:")
        print("\n  Option 1: Run simulate_historical_event_losses.py to generate exposure")
        print("  Open: scripts/hazard/simulate_historical_event_losses.py")
        print("  Run until you see: exp.write_hdf5(...)")
